...
<div class="form-floating mb-3 mt-5 <?= isset($errors['username']) && $errors['username'] !== '' ? 'border-danger' : '' ?>">
        <input type="text" class="form-control" id="floatingInput" placeholder="username" name="username" value="<?= isset($username) ? htmlspecialchars($username) : '' ?>">
        <label style="color: black;" for="floatingInput">Username</label>
    </div>

    <div class="form-floating mb-3">
        <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="email" value="<?= isset($email) ? htmlspecialchars($email) : '' ?>">
    ...
    <div class="form-floating mb-2 <?= isset($errors['general']) && $errors['general'] !== '' ? 'border-danger' : '' ?>">
        <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="password" value="<?= isset($password) ? htmlspecialchars($password) : '' ?>">
        <label style="color: black;" for="floatingPassword">Password</label>
    </div>
    <a href="index.php">
    <button type="button" class="mb-3 mt-4 btn btn-danger">Save</button>
</a>
</form>
</body>
</html>